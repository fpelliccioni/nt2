...
namespace boost { namespace simd
{
  ...
  {
    /*!
      @brief Define the unaligned_load function tag

      Define the tag representing the unaligned_load function in generic contexts.
    **/
    struct unaligned_load_ : ext::elementwise_<unaligned_load_>
    {
      typedef ext::elementwise_<unaligned_load_> parent;
    };
  }
